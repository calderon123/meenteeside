...
public class TwiceAWeek3 extends AppCompatActivity {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    if (userMentor.getExpertise().equals("Marriage Counselor") && userMentor.getRate().equals("500-1500/hour")
                            && userMentor.getAvailability().equals("Twice a week")){
                        mUsermentor.add(userMentor);
                    }else if (userMentor.getExpertise().equals("Marriage Counselor") && userMentor.getRate().equals("500-1000/hour")
                            && userMentor.getAvailability().equals("Twice a week")){
                        mUsermentor.add(userMentor);
                    }
                }
