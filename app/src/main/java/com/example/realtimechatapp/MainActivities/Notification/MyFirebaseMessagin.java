package com.example.realtimechatapp.MainActivities.Notification;
...
public class MyFirebaseMessagin extends FirebaseMessagingService {
    @Override
    ...
    private void sendOreoNotification(RemoteMessage remoteMessage) {
        ...
        Intent intent = new Intent(this, MenteeMainActivity.class);
